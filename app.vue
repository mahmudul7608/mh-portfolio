<template>
  <div id="app">
    ...
    >
      ...
      <div
        class="absolute inset-0 -z-10 galaxy-bg"
        ...
        >
          ...
          <div class="relative w-11 h-11 mb-2">
            ...
            <div class="absolute inset-0 flex items-center justify-center">
              <span class="text-[9px] font-semibold text-white/80"
          ...
          <div class="flex flex-col items-center space-y-2">
            ...
            >
              ...
              <a
                :href="item.href"
                class="w-11 h-11 rounded-full flex items-center justify-center bg-gray-800/60 backdrop-blur-sm text-gray-400 shadow-sm transition-all duration-300 cursor-pointer hover:bg-gray-700/70 hover:text-white hover:shadow-md hover:scale-110 active:scale-95"
                :class="[
                  activeSection === item.href
                    ? 'border-2 border-purple-500/80 shadow-lg shadow-purple-500/30'
      ...
      >
        ...
        >
          <!-- LinkedIn -->
          <a
            href="https://www.linkedin.com/in/mh-meraj/"
            target="_blank"
        ...
        <div class="max-w-3xl">
          ...
          <p class="mt-3 text-white/70 text-base sm:text-lg leading-relaxed">
            ...
            dedicated to crafting beautiful, responsive, and high-performance
            web experiences.
          </p>
      ...
      <section
        ...
        class="relative py-8 px-6 overflow-hidden"
      >
      ...
      <!-- tools section start -->
      <section id="tools-i-use" class="mt-6 bg-black-500 py-8 px-6">
        <h2
                    ...
                    >
                      <defs>
                        ...
                        >
                          <stop
                            offset="0%"
                            style="stop-color: #7d2ae8; stop-opacity: 1"
                          />
                          <stop
                            offset="100%"
                      ...
                      <path
                        fill="#fff"
                        d="M128 70c-32 0-58 26-58 58s26 58 58 58 58-26 58-58-26-58-58-58zm0 96c-21 0-38-17-38-38s17-38 38-38 38 17 38 38-17 38-38 38z"
                      />
          ...
          >
            <div class="grid md:grid-cols-2 gap-6 md:gap-10 items-center">
              ...
              <div class="space-y-4 h-full">
                ...
                <div>
                  <h3
                    class="text-2xl md:text-3xl font-bold mb-6 flex items-center gap-4"
                  >
                    <span
                      class="p-2 bg-gray-800 rounded-lg border border-white/10"
                    >
                      <svg
                        class="w-8 h-6 text-purple-400"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                  ...
                  <div class="relative pl-8 border-l-2 border-white/20">
                    ...
                    <div class="relative group">
                      <!-- Timeline Dot -->
                      <div
                        class="absolute -left-[43px] top-0 w-5 h-5 rounded-full border-2 border-white bg-gray-900 group-hover:scale-110 transition-transform duration-300"
                      ></div>

                      <div
                        class="p-6 rounded-2xl bg-gray-900/50 border border-white/10 hover:border-purple-500/50 hover:bg-purple-500/5 transition-all duration-300 backdrop-blur-sm"
                      >
                        <div
                        ...
                        >
                          <div class="pl-4">
                            ...
                            <p
                              class="text-sm text-gray-400 mt-3 flex items-center gap-2"
                            >
                              <svg
                          ...
                          <span
                            class="inline-block px-4 py-1 rounded-full bg-white text-black text-xs font-bold whitespace-nowrap self-start md:self-auto"
                            >2019 - 2024</span
                          >
                        </div>
                      </div>
                ...
                <div>
                  <div class="relative pl-8 border-l-2 border-white/20">
                    ...
                    <div class="relative group">
                      ...
                      <div
                        class="p-6 rounded-2xl bg-gray-900/50 border border-white/10 hover:border-blue-500/50 hover:bg-blue-500/5 transition-all duration-300 backdrop-blur-sm"
                      >
                        <div
                        ...
                        >
                          ...
                          <span
                            class="inline-block px-4 py-1 rounded-full bg-white text-black text-xs font-bold whitespace-nowrap"
                            >2022 – Current</span
                          >
                        </div>
                        ...
                        <div class="space-y-2.5 pl-4">
                          <div class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-300"
                              ><strong>Frontend:</strong> HTML, CSS, Tailwind,
                              JS (ES6+), Vue, Nuxt, React</span
                            >
                          </div>
                          <div class="flex items-start gap-3">
                            <span
                            ...
                            ></span>
                            <span class="text-sm text-gray-300"
                              ><strong>Focus:</strong> Responsive UI, real-world
                              projects</span
                            >
                          </div>
                          <div class="flex items-start gap-3">
                            ...
                            ></span>
                            <span class="text-sm text-gray-300"
                              ><strong>Workflow:</strong> Git, GitHub, version
                              control</span
                            >
                          </div>
                        </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4">
                  <!-- Stat 1 -->
                  <div
                    class="p-4 rounded-xl bg-gray-900/50 border border-white/10 text-center hover:border-purple-500/50 hover:bg-purple-500/5 hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300"
                  >
                  ...
                  <!-- Stat 2 -->
                  <div
                    class="p-4 rounded-xl bg-gray-900/50 border border-white/10 text-center hover:border-blue-500/50 hover:bg-blue-500/5 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300"
                  >
                  ...
                  <!-- Stat 3 -->
                  <div
                    class="p-4 rounded-xl bg-gray-900/50 border border-white/10 text-center hover:border-green-500/50 hover:bg-green-500/5 hover:shadow-lg hover:shadow-green-500/10 transition-all duration-300"
                  >
                  ...
                  <!-- Stat 4 -->
                  <div
                    class="p-4 rounded-xl bg-gray-900/50 border border-white/10 text-center hover:border-pink-500/50 hover:bg-pink-500/5 hover:shadow-lg hover:shadow-pink-500/10 transition-all duration-300"
                  >
              ...
              <div
                class="flex flex-col items-center text-center space-y-6 h-full justify-center"
              >
                <!-- Image -->
                <div class="relative w-full sm:w-[80%] md:w-[85%] lg:w-[80%]">
                  ...
                  <div class="absolute -inset-3 -z-10">
                    <div class="relative mx-auto w-[95%] aspect-square">
                      ...
                      <div
                        class="absolute inset-0 rounded-full bg-gradient-to-r from-purple-500/20 via-cyan-500/20 to-pink-500/20 blur-2xl"
                      ></div>
                    </div>
                  </div>
...
useHead({
  ...
  meta: [
    {
      name: "description",
      content:
        "Portfolio of Mahmudul Hasan, a Frontend Developer specialized in Vue.js, Nuxt.js, and modern web design.",
    },
    {
      name: "keywords",
      content:
        "Mahmudul Hasan, Frontend Developer, Web Designer, Vue.js, Nuxt.js, React, Portfolio",
    },
    ...
    {
      property: "og:title",
      content: "Mahmudul Hasan | web designer and developer",
    },
    {
  ...
  link: [{ rel: "icon", type: "image/png", href: "/image/HM-image-1.png" }],
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        description:
          "Frontend Developer dedicated to crafting beautiful, responsive, and high-performance web experiences.",
      }),
    },
  ],
});
...
const projects = ref([
  {
    ...
    description:
      "Full-featured e-commerce platform with modern UI, seamless shopping experience, and secure payment integration",
  ...
  },
  {
    ...
    description:
      "AI-powered idea generation with real-time results, creative solutions, and intelligent recommendations for your projects",
  ...
  },
  {
    ...
    description:
      "AI trip planner with personalized itineraries, smart recommendations, and automated travel planning for perfect vacations",
    technologies: ["Nuxt.js", "TailwindCSS", "JavaScript", "API"],
  ...
  },
  {
    ...
    description:
      "Interactive restaurant menu with dynamic ordering, real-time customization, and seamless food delivery integration",
    technologies: ["Nuxt.js", "TailwindCSS", "JavaScript", "API"],
  ...
  },
  {
    ...
    description:
      "Professional hotel booking with elegant design, luxury accommodations, and premium reservation management system",
  ...
  },
  {
    ...
    description:
      "Modern AI design showcase with stunning effects, cutting-edge animations, and futuristic visual experiences",
    technologies: ["Nuxt.js", "TailwindCSS", "JavaScript", "API"],
...
.horizontal-stars {
  ...
  background-image:
    radial-gradient(3px 3px at 0% 20%, white, transparent),
...
.orbit-icon:active {
  box-shadow:
    0 0 0 4px rgba(2, 6, 23, 0.6),
    0 10px 28px rgba(0, 188, 212, 0.35);
}
